...
(async function MeetingTypesPage() {
  ...
  // Buffer After field is now functional — enforced in availability slot calculation.
  // "Time Between Meetings" = how often candidate slots start (slotInterval).
  // "Buffer After" = additional gap after each booked meeting before the next can start.
